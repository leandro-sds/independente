...
**Como trocar:** Aparência → Personalizar → Estilo Visual → Publicar

A mudança é instantânea e reversível. Nenhum conteúdo é perdido.

Todas as animações respeitam `prefers-reduced-motion` — quem prefere sem animações, navega sem elas.

Todos os pares de cor/fundo foram validados com contraste WCAG AA (mínimo 4.5:1).
...
- Cabeçalho azul-petróleo com gradiente sutil
- Linha dourada que se expande ao carregar
- Menu hover com fundo dourado transparente subindo suavemente
- Títulos com entrada suave — fadeIn universal
- Blockquote com borda dourada e aspas decorativas
...
- Cabeçalho com gradiente roxo escuro animado
- Linha que alterna entre magenta e ciano pulsando
- Menu hover com fundo magenta e glow elétrico
- Títulos com entrada de display LED — brilho magenta
- Blockquote com glassmorphism e borda magenta
...
**Ideal para:** rádios retrô, música clássica, jazz, blues, saudosismo, cafeterias, livrarias.

- Cabeçalho com gradiente marrom escuro
...
## ✍️ Tinta & Papel — Escritor e Literatura
...
**Ideal para:** rádios jovens, podcasts, games, e-sports, startups, agências digitais, artistas, músicos, criadores de conteúdo.
...
## Recursos comuns a todos os estilos
...
- Crédito do desenvolvedor personalizável no rodapé
...
## Outras configurações no Personalizador

...
<?php
/**
 * Área de Destaque — largura total, logo abaixo do cabeçalho.
 * Exibida apenas quando há widgets nela. No celular, é o primeiro
 * elemento após o cabeçalho. Aceita qualquer widget (player, banner,
 * imagem, chamada para ação, etc.).
 */
if ( is_active_sidebar( 'destaque' ) ) : ?>
<section class="destaque-section" aria-label="<?php esc_attr_e( 'Destaque', 'independente' ); ?>">
